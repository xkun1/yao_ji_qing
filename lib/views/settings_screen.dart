...
class SettingsScreen extends StatelessWidget {
  ...
  Widget _buildTile(
    ...
    return ListTile(
      ...
      title: Text(title, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF1F2937))),
      subtitle: Text(subtitle, style: const TextStyle(fontSize: 12, color: Color(0xFF6B7280))),
      trailing: onTap != null ? const Icon(Icons.chevron_right_rounded, color: Color(0xFFD1D5DB)) : null,
    );
  }
