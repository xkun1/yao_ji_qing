...
class _SetupGuideScreenState extends State<SetupGuideScreen>
  ...
  Future<void> _updateActualStatus() async {
    ...
    try {
      final Map<dynamic, dynamic>? status =
          await const MethodChannel('yao_ji_qing/medication_vibration')
  ...
  Widget build(BuildContext context) {
    ...
    final bool canProceed = _batteryDone &&
        _alarmsDone &&
        _notificationsDone &&
        (isIOS || _autoStartDone);
  ...
  Widget _buildStepCard({
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: isDone ? const Color(0xFFBBF7D0) : const Color(0xFFF3F4F6),
            width: 1.2),
      ),
      child: Row(
        children: [
